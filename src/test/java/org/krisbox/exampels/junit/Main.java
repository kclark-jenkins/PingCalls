...
public class Main {
    ...
    private final String CONTROL_CLIENT_ID = "xxxx";
    private final String CONTROL_API_KEY   = "xxxx";
    ...
    private final String PING_BASE_URL     = "https://directory-api.pingone.com/api/directory/";
    private final String PING_USER_URL     = "https://directory-api.pingone.com/v1/user/";
    private final String PING_GROUP_URL    = "https://directory-api.pingone.com/v1/group/";
    private final String PING_DELETE_URL   = "https://directory-api.pingone.com/v1/user/";
    private final String PING_AUTH_URL     = "https://directory-api.pingone.com/api/oauth/token";
    private final String PING_INVITE_URL   = "https://directory-api.pingone.com/v1/useractions/invite";
    private final String PING_GROUP_COUNT_URL = "https://directory-api.pingone.com/v1/group/";
